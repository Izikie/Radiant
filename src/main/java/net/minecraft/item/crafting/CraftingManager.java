...
public class CraftingManager {
    ...
    private CraftingManager() {
        ...
        this.addRecipe(new ItemStack(Blocks.planks, 4, 4 + BlockPlanks.WoodType.ACACIA.getMetadata() - 4), "#", '#', new ItemStack(Blocks.log2, 1, BlockPlanks.WoodType.ACACIA.getMetadata() - 4));
        this.addRecipe(new ItemStack(Blocks.planks, 4, 4 + BlockPlanks.WoodType.DARK_OAK.getMetadata() - 4), "#", '#', new ItemStack(Blocks.log2, 1, BlockPlanks.WoodType.DARK_OAK.getMetadata() - 4));
