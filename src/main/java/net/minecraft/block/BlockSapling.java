...
public class BlockSapling extends BlockBush implements IGrowable {
    public static final PropertyEnum<BlockPlanks.WoodType> TYPE = PropertyEnum.create("type", BlockPlanks.WoodType.class);
    public static final PropertyInteger STAGE = PropertyInteger.create("stage", 0, 1);

    protected BlockSapling() {
        this.setDefaultState(this.blockState.getBaseState().withProperty(TYPE, BlockPlanks.WoodType.OAK).withProperty(STAGE, 0));
        float f = 0.4F;
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        switch (state.getValue(TYPE)) {
            case SPRUCE:
                ...
                for (i = 0; i >= -1; --i) {
                    for (j = 0; j >= -1; --j) {
                        if (this.func_181624_a(worldIn, pos, i, j, BlockPlanks.WoodType.SPRUCE)) {
            ...
            case JUNGLE:
                ...
                for (i = 0; i >= -1; --i) {
                    for (j = 0; j >= -1; --j) {
                        if (this.func_181624_a(worldIn, pos, i, j, BlockPlanks.WoodType.JUNGLE)) {
            ...
            case DARK_OAK:
                ...
                for (i = 0; i >= -1; --i) {
                    for (j = 0; j >= -1; --j) {
                        if (this.func_181624_a(worldIn, pos, i, j, BlockPlanks.WoodType.DARK_OAK)) {
    ...
    private boolean func_181624_a(World p_181624_1_, BlockPos p_181624_2_, int p_181624_3_, int p_181624_4_, BlockPlanks.WoodType p_181624_5_) {
    ...
    public boolean isTypeAt(World worldIn, BlockPos pos, BlockPlanks.WoodType type) {
