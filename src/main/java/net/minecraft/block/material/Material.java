...
public class Material {
    ...
    public static final Material GLASS = new Material(MapColor.AIR_COLOR).setTranslucent();
    public static final Material REDSTONE_LIGHT = new Material(MapColor.AIR_COLOR);
    ...
    public static final Material ICE = new Material(MapColor.ICE_COLOR).setTranslucent();
    public static final Material PACKED_ICE = new Material(MapColor.ICE_COLOR);
