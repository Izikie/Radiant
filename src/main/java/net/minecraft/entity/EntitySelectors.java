...
public final class EntitySelectors {
    public static final Predicate<Entity> SELECT_ANYTHING = Entity::isEntityAlive;
    ...
    public static final Predicate<Entity> SELECT_INVENTORIES = p_apply_1_ -> p_apply_1_ instanceof IInventory && p_apply_1_.isEntityAlive();
    public static final Predicate<Entity> NOT_SPECTATING = p_apply_1_ -> !(p_apply_1_ instanceof EntityPlayer entityPlayer) || !entityPlayer.isSpectator();
