...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    private void registerItems() {
        ...
        this.registerBlock(Blocks.leaves2, BlockPlanks.WoodType.ACACIA.getMetadata() - 4, "acacia_leaves");
        this.registerBlock(Blocks.leaves2, BlockPlanks.WoodType.DARK_OAK.getMetadata() - 4, "dark_oak_leaves");
        ...
        this.registerBlock(Blocks.log2, BlockPlanks.WoodType.ACACIA.getMetadata() - 4, "acacia_log");
        this.registerBlock(Blocks.log2, BlockPlanks.WoodType.DARK_OAK.getMetadata() - 4, "dark_oak_log");
