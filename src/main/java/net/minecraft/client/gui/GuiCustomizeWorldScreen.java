...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
    ...
    private final Predicate<String> field_175332_D = new Predicate<>() {
                    ...
                    for (int i = 0; i < this.field_175349_r.getSize(); ++i) {
                        ...
                        if (gui instanceof GuiButton guibutton) {
                            ...
                            if (guibutton instanceof GuiSlider guiSlider) {
                                ...
                                guiSlider.func_175219_a(MathHelper.clamp_float(f, 0.0F, 1.0F));
                        ...
                        if (gui1 instanceof GuiButton guibutton1) {
                            ...
                            if (guibutton1 instanceof GuiSlider guiSlider) {
                                ...
                                guiSlider.func_175219_a(MathHelper.clamp_float(f1, 0.0F, 1.0F));
