...
public abstract class Container {
    public final List<ItemStack> inventoryItemStacks = new ArrayList<>();
    ...
    protected final List<ICrafting> crafters = new ArrayList<>();
    ...
    public static void computeStackSize(Set<Slot> p_94525_0_, int p_94525_1_, ItemStack p_94525_2_, int p_94525_3_) {
        switch (p_94525_1_) {
            case 0:
                p_94525_2_.stackSize = MathHelper.floor((float) p_94525_2_.stackSize / p_94525_0_.size());
                break;
    ...
    public static int calcRedstone(TileEntity te) {
        return te instanceof IInventory iInventory ? calcRedstoneFromInventory(iInventory) : 0;
    }
