...
import static net.radiant.BufferUtils.createByteBuffer;
...
public class Display {
    ...
    public static void create() throws LWJGLException {
        ...
        GLFWVidMode vidMode = glfwGetVideoMode(monitor);
        if (vidMode != null) {
            glfwSetWindowPos(Window.handle, (vidMode.width() - mode.getWidth()) / 2, (vidMode.height() - mode.getHeight()) / 2);
        }
...
//		Display.drawable = drawable;
    ...
    public static void setInitialBackground(float red, float green, float blue) {
        ...
        if (Window.handle != MemoryUtil.NULL) {
            GL46.glClearColor(red, green, blue, 1f);
