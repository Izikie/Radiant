...
public class GL20x {
    ...
    public static void glVertexAttribPointer(int index, int size,
        ...
        int type = unsigned ? GL46.GL_UNSIGNED_BYTE : GL46.GL_BYTE;
    ...
    public static void glVertexAttribPointer(int index, int size,
        ...
        int type = unsigned ? GL46.GL_UNSIGNED_SHORT : GL46.GL_SHORT;
    ...
    public static void glVertexAttribPointer(int index, int size,
        ...
        int type = unsigned ? GL46.GL_UNSIGNED_INT : GL46.GL_INT;
        GL20.nglVertexAttribPointer(index, size, type, normalized, stride, MemoryUtil.memAddress(buffer));
    }
