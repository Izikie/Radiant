...
public class Blocks {
    ...
    public static final Block LOG_2;
    public static final BlockLeaves LEAVES;
    public static final BlockLeaves LEAVES_2;
    ...
    public static final BlockTallGrass TALL_GRASS;
    ...
    public static final BlockSlab DOUBLE_STONE_SLAB_2;
    public static final BlockSlab BLOCK_SLAB;
    ...
    static {
        if (!Bootstrap.isRegistered()) {
            ...
            SAPLING = get("sapling");
            BEDROCK = get("bedrock");
            FLOWING_WATER = (BlockDynamicLiquid) get("flowing_water");
            WATER = (BlockStaticLiquid) get("water");
            FLOWING_LAVA = (BlockDynamicLiquid) get("flowing_lava");
            LAVA = (BlockStaticLiquid) get("lava");
            ...
            LEAVES_2 = (BlockLeaves) get("leaves2");
            SPONGE = get("sponge");
            GLASS = get("glass");
            ...
            STICKY_PISTON = (BlockPistonBase) get("sticky_piston");
            WEB = get("web");
            TALL_GRASS = (BlockTallGrass) get("tallgrass");
            DEAD_BUSH = (BlockDeadBush) get("deadbush");
            PISTON = (BlockPistonBase) get("piston");
            PISTON_HEAD = (BlockPistonExtension) get("piston_head");
            WOOL = get("wool");
            PISTON_EXTENSION = (BlockPistonMoving) get("piston_extension");
            YELLOW_FLOWER = (BlockFlower) get("yellow_flower");
            RED_FLOWER = (BlockFlower) get("red_flower");
            BROWN_MUSHROOM = (BlockBush) get("brown_mushroom");
            RED_MUSHROOM = (BlockBush) get("red_mushroom");
            GOLD_BLOCK = get("gold_block");
            IRON_BLOCK = get("iron_block");
            DOUBLE_STONE_SLAB = (BlockSlab) get("double_stone_slab");
            STONE_SLAB = (BlockSlab) get("stone_slab");
            ...
            CAKE = get("cake");
            UNPOWERED_REPEATER = (BlockRedstoneRepeater) get("unpowered_repeater");
            POWERED_REPEATER = (BlockRedstoneRepeater) get("powered_repeater");
            ...
            MYCELIUM = (BlockMycelium) get("mycelium");
            ...
            DOUBLE_WOODEN_SLAB = (BlockSlab) get("double_wooden_slab");
            WOODEN_SLAB = (BlockSlab) get("wooden_slab");
            COCOA = get("cocoa");
            ...
            SLIME_BLOCK = get("slime");
            DOUBLE_PLANT = (BlockDoublePlant) get("double_plant");
            ...
            DOUBLE_STONE_SLAB_2 = (BlockSlab) get("double_stone_slab2");
            BLOCK_SLAB = (BlockSlab) get("stone_slab2");
        }
    }
}
