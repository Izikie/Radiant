...
public class WorldRenderer {
    ...
    public void putColorRGB_F(float red, float green, float blue, int p_178994_4_) {
        ...
        int j = Math.clamp((int) (red * 255.0F), 0, 255);
        int k = Math.clamp((int) (green * 255.0F), 0, 255);
        int l = Math.clamp((int) (blue * 255.0F), 0, 255);
    ...
    public void putColorMultiplierRgba(float p_putColorMultiplierRgba_1_, float p_putColorMultiplierRgba_2_, float p_putColorMultiplierRgba_3_, float p_putColorMultiplierRgba_4_, int p_putColorMultiplierRgba_5_) {
        ...
        if (!this.noColor) {
            ...
            if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
                int k = (int) ((j & 255) * p_putColorMultiplierRgba_1_);
                int l = (int) ((j >> 8 & 255) * p_putColorMultiplierRgba_2_);
                int i1 = (int) ((j >> 16 & 255) * p_putColorMultiplierRgba_3_);
                int j1 = (int) ((j >> 24 & 255) * p_putColorMultiplierRgba_4_);
                j = j1 << 24 | i1 << 16 | l << 8 | k;
            } else {
                int k1 = (int) ((j >> 24 & 255) * p_putColorMultiplierRgba_1_);
                int l1 = (int) ((j >> 16 & 255) * p_putColorMultiplierRgba_2_);
                int i2 = (int) ((j >> 8 & 255) * p_putColorMultiplierRgba_3_);
                int j2 = (int) ((j & 255) * p_putColorMultiplierRgba_4_);
