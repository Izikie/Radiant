...
public class ModelEnderMite extends ModelBase {
    ...
    public ModelEnderMite() {
        ...
        for (int i = 0; i < this.bodyParts.length; ++i) {
            ...
            this.bodyParts[i].addBox(field_178716_a[i][0] * -0.5F, 0.0F, field_178716_a[i][2] * -0.5F, field_178716_a[i][0], field_178716_a[i][1], field_178716_a[i][2]);
            this.bodyParts[i].setRotationPoint(0.0F, (24 - field_178716_a[i][1]), f);
