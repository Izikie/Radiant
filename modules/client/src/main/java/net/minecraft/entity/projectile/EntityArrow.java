...
import net.minecraft.network.packet.impl.play.server.S2BPacketChangeGameState;
...
public class EntityArrow extends Entity implements IProjectile {
    ...
    public EntityArrow(World worldIn, EntityLivingBase shooter, EntityLivingBase target, float velocity, float innacuracy) {
        ...
        if (d3 >= 1.0E-7D) {
            ...
            this.setThrowableHeading(d0, d1 + f2, d2, velocity, innacuracy);
        }
    }
    ...
    public void setThrowableHeading(double x, double y, double z, float velocity, float inaccuracy) {
        ...
        this.prevRotationPitch = this.rotationPitch = (float) (Math.atan2(y, f1) * 180.0D / Math.PI);
    ...
    public void setVelocity(double x, double y, double z) {
        ...
        if (this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
            ...
            this.prevRotationYaw = this.rotationYaw = (float) (Math.atan2(x, z) * 180.0D / Math.PI);
            this.rotationPitch = (float) (Math.atan2(y, f) * 180.0D / Math.PI);
    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            if (this.getIsCritical()) {
                for (int k = 0; k < 4; ++k) {
                    this.worldObj.spawnParticle(ParticleTypes.CRIT, this.posX + this.motionX * k / 4.0D, this.posY + this.motionY * k / 4.0D, this.posZ + this.motionZ * k / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
                }
            }
            ...
            if (this.isInWater()) {
                for (int i1 = 0; i1 < 4; ++i1) {
                    float f8 = 0.25F;
                    this.worldObj.spawnParticle(ParticleTypes.WATER_BUBBLE, this.posX - this.motionX * f8, this.posY - this.motionY * f8, this.posZ - this.motionZ * f8, this.motionX, this.motionY, this.motionZ);
                }
