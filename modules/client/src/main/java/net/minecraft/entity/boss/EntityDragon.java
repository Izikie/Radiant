...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob {
    ...
    public double[] getMovementOffsets(int p_70974_1_, float p_70974_2_) {
        ...
        double d1 = MathHelper.wrapAngle(this.ringBuffer[j][0] - d0);
    ...
    public void onLivingUpdate() {
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            this.worldObj.spawnParticle(ParticleTypes.EXPLOSION_LARGE, this.posX + f11, this.posY + 2.0D + f13, this.posZ + f14, 0.0D, 0.0D, 0.0D);
        } else {
            ...
            this.rotationYaw = MathHelper.wrapAngle(this.rotationYaw);
            ...
            if (this.isAIDisabled()) {
                ...
                if (this.worldObj.isRemote) {
                    if (this.newPosRotationIncrements > 0) {
                        ...
                        double d2 = MathHelper.wrapAngle(this.newRotationYaw - this.rotationYaw);
                    ...
                    d12 = d12 / MathHelper.sqrt(d11 * d11 + d13 * d13);
                    float f17 = 0.6F;
                    d12 = Math.clamp(d12, (-f17), f17);
                    this.motionY += d12 * 0.10000000149011612D;
                    this.rotationYaw = MathHelper.wrapAngle(this.rotationYaw);
                    double d4 = 180.0D - Math.atan2(d11, d13) * 180.0D / Math.PI;
                    double d6 = MathHelper.wrapAngle(d4 - this.rotationYaw);
                    ...
                    float f6 = MathHelper.sqrt(this.motionX * this.motionX + this.motionZ * this.motionZ) + 1.0F;
                ...
                this.dragonPartHead.setLocationAndAngles(this.posX + (f18 * 5.5F * f2), this.posY + (adouble[1] - adouble1[1]) + (f15 * 5.5F), this.posZ - (f19 * 5.5F * f2), 0.0F, 0.0F);
                ...
                for (int j = 0; j < 3; ++j) {
                    ...
                    entitydragonpart.setLocationAndAngles(this.posX - ((f16 * f23 + f21 * f24) * f2), this.posY + (adouble2[1] - adouble1[1]) - ((f24 + f23) * f15) + 1.5D, this.posZ + ((f4 * f23 + f22 * f24) * f2), 0.0F, 0.0F);
                }
    ...
    private void attackEntitiesInList(List<Entity> p_70971_1_) {
        for (Entity value : p_70971_1_) {
            ...
            if (value instanceof EntityLivingBase) {
                value.attackEntityFrom(DamageSource.causeMobDamage(this), 10.0F);
                this.applyEnchantments(this, value);
            }
        }
    }
    ...
    private boolean destroyBlocksInAABB(AxisAlignedBB p_70972_1_) {
        ...
        if (flag1) {
            ...
            this.worldObj.spawnParticle(ParticleTypes.EXPLOSION_LARGE, d0, d1, d2, 0.0D, 0.0D, 0.0D);
        }
    ...
    protected void onDeathUpdate() {
        ...
        if (this.deathTicks >= 180 && this.deathTicks <= 200) {
            ...
            this.worldObj.spawnParticle(ParticleTypes.EXPLOSION_HUGE, this.posX + f, this.posY + 2.0D + f1, this.posZ + f2, 0.0D, 0.0D, 0.0D);
        }
