...
public class MicrosoftAuthenticator {
    ...
    public MicrosoftAuthResult loginWithTokens(AuthTokens tokens, boolean retrieveProfile) throws MicrosoftAuthenticationException {
        XboxLoginResponse xboxLiveResponse = xboxLiveLogin(tokens.accessToken());
        ...
        if (Arrays.stream(storeResponse.items()).noneMatch(item -> item.name().equals(MINECRAFT_STORE_IDENTIFIER))) {
        ...
        return new MicrosoftAuthResult(
                ...
                minecraftResponse.getAccessToken(),
                tokens.refreshToken(),
                minecraftResponse.getExpiresIn(),
