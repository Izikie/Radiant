 ...
 * @version 1.1.5
 */
public record MicrosoftAuthResult(MinecraftProfile profile, String accessToken, String refreshToken, long expiresIn,
                                  String xuid, String clientId) {
    ...
    /**
     * @return The time before the access token expires
     */
    @Override
